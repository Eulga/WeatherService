package pickmeal.dream.test.service;
...
public class WeatherService {
	...
	private Weather getWeather(String nx, String ny, String date, String hour, String minute) {
	 ...
	 * 
	 */
	private void getShortTermWeather(HashMap<String, String> categoryAndValue, String url, String date, String hour, String minute, String nx, String ny, String... reqCodes) {
	 ...
	 */
	private void getShortTermLiveWeather(HashMap<String, String> categoryAndValue, String url, String date, String hour, String minute, String nx, String ny, String... reqCodes) {
		int cm = Integer.parseInt(minute);
		/*
		 * checkMinute 기준시간(현재시간)이 30분 이전이라면 한 시간 전을 측정한다.
	...
	private String toStringHour(String hour, int calcNum) {
	...
	//JSON타입 1차 가공
	private String[] getWeatherApiInfo(String url) {
...
//			System.out.println(apiResponse.substring(apiResponse.indexOf("resultCode"), apiResponse.indexOf(",")));
	 ...
	 */
	private void getCategoryAndValue(String[] itemPieces, String[] reqCodes, HashMap<String, String> categoryAndValue) {
		String category = "";
		String value = "";
		String[] keyValue;
